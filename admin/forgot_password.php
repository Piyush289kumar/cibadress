        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-4 col-md-4">
                    <!-- logo -->
                    <img class="logo" src="../images/_login_page_logo.png" alt="Valmiki Sangam">
                    <!-- logo -->
                    ...
                    if (isset($_POST['login'])) {
                        ...
                        $sql_user_pass_cheack = "SELECT * FROM user WHERE username = '{$username}'";
                        ...
                        if (mysqli_num_rows($result_sql_user_pass_cheack) > 0) {
                            while ($row = mysqli_fetch_assoc($result_sql_user_pass_cheack)) {
                                ...
                                $_SESSION['forgot_username'] = $row['username'];
