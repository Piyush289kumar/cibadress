...
if (isset($_POST['submit'])) {
    ...
    $sql_update_user = "UPDATE user SET first_name= '{$fname}', last_name= '{$lname}',username='{$username}', email='{$email}', phone='{$phone}', role='{$role}', img = '{$save_img_name}' WHERE user_id='{$user_id_getaddbar}'";
            ...
            <div class="col-md-offset-4 col-md-4">
                ...
                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="phone" name="phone" class="form-control" value="<?php echo $row['phone'] ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
